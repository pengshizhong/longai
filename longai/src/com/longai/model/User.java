...
public class User implements java.io.Serializable {
	...
	/** full constructor */
	public User(String name, String nickname, String email, String location,
			String biography, String profilepic, String gender, String type,
			Double preferencegens, Double selfgens, String userId,
			Set momentlikes, Set momentcomments, Set newslikes,
			Set newscomments, Set enrolls) {
		this.name = name;
